...
fn SkillBadge(
    ...
    view! {
        <button class=format!("btn btn-outline p-7 lg:p-4 text-2xl lg:text-[11px] font-black border-2 gap-3 hover:scale-105 transition-all duration-200 h-auto min-h-0 uppercase tracking-tighter {}", color_class)>
            <i class=format!("{} text-3xl lg:text-base", icon_class)></i>
            {name}
        </button>
    }
}
        ...
        <div class="min-h-screen lg:h-screen lg:overflow-hidden bg-base-100 text-base-content font-mono p-6 lg:p-12 flex items-center justify-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 max-w-7xl w-full h-full lg:max-h-[90vh]">
                ...
                <div class="lg:col-span-6 bg-base-300/30 rounded-[3rem] p-8 lg:p-10 border border-white/5 shadow-2xl flex flex-col h-full overflow-hidden">
                    ...
                    <div class="mt-auto pt-8 flex gap-4 lg:gap-2">
                        <a href="mailto:asaedreyesmedina@gmail.com" class="btn btn-primary flex-1 text-2xl lg:text-sm h-20 lg:h-12 font-black rounded-2xl uppercase tracking-widest">
                            Contactar
                        </a>
                        <a href="https://github.com" target="_blank" class="btn btn-outline px-10 text-2xl lg:text-sm h-20 lg:h-12 font-black rounded-2xl">
                           <i class="devicon-github-original text-3xl lg:text-xl"></i>
                        </a>
                    </div>
                </div>
            </div>
